 ...
 * @author Markus
 */
public class EmprestimoDAOImpl extends LCDAOImpl {

    public EmprestimoDAOImpl(Usuario usr) {
        super(usr);
    }
    ...
    public Collection selectFiltro(Emprestimo filtro) throws SelectObjectException {
        Criteria criteria = createCriteria();
        filtroPorPessoa(filtro, criteria);
        filtroPorBemMaterial(filtro, criteria);
        filtroPorStatus(filtro, criteria);
        return criteria.list();
    }
